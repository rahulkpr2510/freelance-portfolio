...
export function TeamMemberCard({
  ...
  return (
    <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-950/60 flex flex-col justify-evenly transition-all hover:border-fuchsia-400/30 hover:bg-zinc-900/70 hover:shadow-lg hover:shadow-fuchsia-500/5">
      {/* Top: Avatar + Info */}
